...
def main() -> None:
    ...
    train_index = build_index_table(train_raw, train_story_indices, K=args.k_steps, limit_samples=None)
    val_index = build_index_table(train_raw, val_story_indices, K=args.k_steps, limit_samples=None)
    test_story_indices = list(range(len(test_raw)))
    test_index = build_index_table(test_raw, test_story_indices, K=args.k_steps, limit_samples=None)
